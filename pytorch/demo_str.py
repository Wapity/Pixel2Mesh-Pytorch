...
args.add_argument('image',
                  help='Testing image.',
                  type=str,
                  default='Data/examples/plane.png')
...
args.add_argument('weight_decay',
                  ...
                  type=float,
                  default=5e-6)
args.add_argument('cnn_type', help='CNN TYPE', type=str, default='STR')
...
print('---- Model Created')
#model.load_state_dict(torch.load('Data/tf_res_from_vgg.pt'))
...
output3 = model(img_inp, img_inp)[-1]
...
torch.save(model.state_dict(), 'Data/tf_res_from_vgg.pt')
